...
function addIcon() {
    const huggingFaceLogo = "../imgs/geniverse.jpeg";
...
function addGithubButton() {
    const div = `
        <div class="github-repo">
            <a 
                class="github-button"
                href="https://github.com/javismiles/HuggingGAN/" data-size="large" data-show-count="true" aria-label="Star huggingface/pytorch-transformers on GitHub">
                Star
            </a>
        </div>
    `;
